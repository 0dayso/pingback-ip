<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Alipay.aspx.cs" Inherits="Admin_Alipay" %>
        ...
        <div id="main">
            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="red-star">*</span>
                        <asp:TextBox ID="TxtTotal_fee" name="TxtTotal_fee" runat="server" Text="0.01" onfocus="if(Number(this.value)==0){this.value='';}"
