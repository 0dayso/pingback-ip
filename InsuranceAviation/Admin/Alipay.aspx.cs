...
public partial class Admin_Alipay : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        this.TxtSubject.Text = User.Identity.Name + "用户充值";
    }

    protected void BtnAlipay_Click(object sender, EventArgs e)
    {
        //生成本地订单
        decimal amount = decimal.Parse(TxtTotal_fee.Text.Trim());
        string orderId = IAClass.Bussiness.Payment.CreateOrder("支付宝", amount);
        ...
        string show_url = "http://www.yoyoyn.com/admin/alipay.aspx";
