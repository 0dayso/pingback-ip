...
namespace EagleString
{
    ...
    /// <summary>
    /// 用法(三步)：
    /// 1.定义Hotkey hotkey = new Options.otherClass.Hotkey(this.Handle);
    /// 2.定义int hotkeyid = hotkey.RegisterHotkey(System.Windows.Forms.Keys.F2, Hotkey.KeyFlags.MOD_SHIFT);
    /// 3.事件处理hotkey.OnHotkey += new HotkeyEventHandler(OnHotkey);
