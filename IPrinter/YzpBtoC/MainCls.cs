...
namespace YzpBtoC
{
    public class gb
    {
        static public string[] gbYzpInsuranceType = null;
        static public Hashtable gbHtPNR_BAOXIAN = new Hashtable();
        static public string tjddPnr = "";
        static public string tjddAddr = "";
        static public string tjddFee = "";
    }
    public class YZPnewOrder
    {
        public string lPNR = "";
        public string lCUSTOMID = "";//
        public string lAGENTID = "";//
        public string lFANYONG = "";
        public string lHXORDERNO = "";//
        public string lISJIFEN = "";
        public string lTOUCHNAME = "";
        public string lTOUCHMOBILE = "";
        public string lTOUCHPHONE = "";
        public string lTOUCHEMAIL = "";
        public string lSENDMETHOD = "";
        public string lSENDADDRESS = "";
        public string lSENDSTOPTIME = "";
        public string lSENDPART = "";
        public string lJIESUANMETHOD = "";
        public string lOPERATIONTYPEID = "";
        public string lINSURANCETYPEID = "";
        public string lORDERTYPE = "";
        public string lREMARK = "";
        public YZPflightINFO[] rFLIGHTINFO;
        public YZPpassINFO[] rPASSINFO;
        public YZPnewOrder()
        {
                     lPNR = "";
         lCUSTOMID = "";//
    ...
    public class YZPflightINFO
    {
        public string rFLIGHTNO = "";
        public string rFLIGHTDATE = "";
        public string rBUNK = "";
        public string rTAXBUILD = "";
        public string rTAXOIL = "";
        public string rTIMELEAVE = "";
        public string rTIMEARRIVE = "";
        public string rCITYLEAVE = "";
        public string rCITYARRIVE = "";
        public string rPLANETYPE = "";
        public string rSTOPSTATION = "";
        public string rAIRLINEID = "";
        public string rSALEPRICE = "";
        public string rAIRLINEINDEX = "";
        public string rDisCount = "";
        public YZPflightINFO()
        {
                     rFLIGHTNO = "";
         rFLIGHTDATE = "";
         rBUNK = "";
    ...
    public class YZPpassINFO
    {
        public string bPASSTYPE = "";
        public string bPASSNAME = "";
        public string bCARDNO = "";
        public string bCARDTYPE = "";
        public string bTKTNO = "";
        public string bPAYPRICE = "";
        public string bSALEPRICE = "";
        public string bHANDBACKPRICE = "";
        public string bINSURANCETYPE = "";
        public string bINSURANCEBASICBPRICE = "";
        public string bINSURANCESALEPRICE = "";
        public string bINSURANCEISFREE = "";
        public string bINSURANCESTATUS = "";
        public string bTICKETCONFIGID = "";
        public string bISBUY = "";
        public string bISESPECIAL = "";
        public string bBackHandMoney = "";
        public string bTaxTotal = "";
        public YZPpassINFO()
        {
            bPASSTYPE = "";
            bPASSNAME = "";
    ...
    public class mystring
    {
        ...
        static private string GetSpell(char source)
        {
            ...
            if (iWord >= -14929) ret = "nuan";//ÐÞÕýÎ»ÖÃ Óë nv
            ...
            if (iWord == -9293) ret = "yan";//Û³ Ê®Áù½øÖÆÖµ-65536
            if (iWord == -7226) ret = "yan";//ãÆ
            if (iWord == -6461) ret = "ting";//æÃ
            if (iWord == -5958) ret = "tao";//èº
            if (iWord == -5427) ret = "hui";//êÍ        
            if (iWord == -18756) ret = "dou";//¶¼(¶àÒô×Ö)
            if (iWord == -21608) ret = "pei";//«˜
            if (iWord == -3613) ret = "xu";//ñã
            if (iWord == -3133) ret = "zhu";//óÃ
            /*
        if(iWord == -15650)ret = "luo";//ÂÞ
        if(iWord == -15642)ret = "luo";//Âæ
            if(iWord == -15657)ret = "lun";//Â×
            if(iWord == -15658)ret = "lun";//ÂÖ
             */
            if (iWord == -6191) ret = "mou";//çÑ
            if (iWord == -6151) ret = "qi";//çù       
            #endregion
            if (iWord == -4929) ret = "wei";
            if (iWord == -9293) ret = "yan";//Û³ Ê®Áù½øÖÆÖµ-65536
            if (iWord == -7226) ret = "yan";//ãÆ
            ...
            if (iWord == -6191) ret = "mou";//çÑ
            if (iWord == -6151) ret = "qi";//çù
            if (iWord == -7183) ret = "long";//ãñ
            if (iWord == -3907) ret = "luan";//ð½
            if (iWord == -9707) ret = "qian";//Ù»
            ...
            {
                //System.out.println("´íÎó£ºÈ¡Æ´Òô "+source+" µÃµ½"+ee.getMessage());
            }
            return ret;
        ...
        static public string GetSpell(string source)
        {
            ...
            //System.out.println("µÃµ½ÖÐÎÄÆ´Òô"+ret);
            return ret.ToUpper(); ;
