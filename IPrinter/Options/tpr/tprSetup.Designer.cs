namespace Options.tpr
{
    partial class tprSetup
    {
        ...
        private void InitializeComponent()
        {
            ...
            "03:30",
            "04:30"});
            this.comboBox1.Location = new System.Drawing.Point(107, 45);
            ...
            "03:30",
            "04:30"});
            this.comboBox2.Location = new System.Drawing.Point(211, 45);
            ...
            this.label5.Text = "TPR或TSL指令说明：\r\n     TSL可做当天报表，TPR做一周内报表\r\n自动产生报表将被存放在安装目录的TPR下\r\n文件名格式为DDMMMYYXX.TPR" +
                "\r\n如DDMMMYY为销售日期，XX表示对该日期\r\n做的第几次TPR指令";
            // 
            // button1
            // 
            ...
            this.Text = "自动报表设置";
            this.Load += new System.EventHandler(this.tprSetup_Load);
